...
const INITIAL_ASSISTANT_MESSAGE =
  "¡Hola! Soy Spectrum, el asistente virtual de Saeta. ¿En qué puedo ayudarte hoy?";
  ...
  return (
    <>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex items-center gap-2 border-t border-border bg-background/80 px-3 py-2">
          <input
            value={input}
